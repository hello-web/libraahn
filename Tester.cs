...
namespace Raahn
{
    class Tester
    {
        ...
        private static void XorTest()
        {
            ...
            ann.ConnectGroups(iToHSig, inputGroup, hiddenGroup, ConnectionGroup.HebbianTrain);
            ann.ConnectGroups(hToOSig, hiddenGroup, outputGroup, ConnectionGroup.HebbianTrain);
